  ...
  return (
    <div className='w-[90%]  h-[100vh] md:h-[90vh] mt-5 shadow-md rounded-md border-2 bg-[#292828d8] border-[#12121244]'>
      <div className='w-full md:h-full flex flex-col md:flex-row '>
          <img src={Stone} alt ='' className='md:w-[50%] h-full bg-[#15f1a8] flex flex-col'/>
      <div className='md:w-[50%] -mt-10 md:mt-0 h-full flex justify-center '>
       ...
       <div className='absolute w-[25%] mt-4 h-[1px] bg-[#4b4949]'/>
      ...
      <button onClick={handleSubmit} className='w-[80%] h-[40px] mt-4 flex justify-center items-center bg-blue-500 text-white rounded-md'>Login</button>
    </div>
        </div>
